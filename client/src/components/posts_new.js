...
class PostsNew extends Component{
  ...
  fileUploadHandler = () =>{
    ...
    axios.post('https://us-centrall-fb-cloud-functions-demo.cloudfunctions.net/uplodFile',fd,{
      onUploadProgress: ProgressEvent =>{
        console.log('uplod progress', + Math.round(ProgressEvent.loaded/ProgressEvent.total * 100)+ '%')
      }
    })
  }
  render(){
